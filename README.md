...
1) The 'EnabledState' register is where an object is toggled
2) Byte placement controls some flags in 'EnabledStateOptions' 
2) Standard states above include (prioritization logic)
